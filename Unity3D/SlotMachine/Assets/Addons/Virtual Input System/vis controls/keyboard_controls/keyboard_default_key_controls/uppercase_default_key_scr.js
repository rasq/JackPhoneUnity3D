...
// tracks whether or not caps lock is enabled
static var uppercaseEnabled : boolean;
...
function Update(){
	...
	if(disableOtherHighlightKeys){
		...
		keyboardControls.eHighlightedKey.GetComponent.<GUITexture>().enabled = false;
		...
		//keyboardControls.uppercaseHighlightedKey.guiTexture.enabled = false;
...
function OnMouseOver(){
	...
	//keyboardControls.uppercaseHighlightedKey.GetComponent.<GUITexture>().enabled = true;
